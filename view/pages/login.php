...
<?php 
    if(isset($_POST['login'])){
        ...
        $util = new Util();
        $util->diferencia_GerEVendedor($_POST['username'], $_POST['password']);
    }
            ...
            <div class="col-md-4 col-md-offset-4">
                <div class="login-panel panel panel-default">
                    <div class="panel-heading">
                        <h3 class="panel-title">Por favor, preencha o login</h3>
                    </div>
                    <div class="panel-body">
                        <form role="form" action="login.php" method="post">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="" name="username" type="text" autofocus required="">
                                </div>
                                <div class="form-group">
